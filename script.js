        ...
        const response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyATsb5Oiz_kY9lAURtnVe3rMINS4wr_nFU', {
            ...
            body: JSON.stringify({
                contents: [
                    {
                        "parts": [{
                            "text": `Com base nos seguintes dados: ${softtekData}\n, forneça uma solução detalhada, passo a passo, para o problema descrito a seguir: ${userInput}. Se precisar, informe-me sobre quais dados adicionais seriam úteis. Se a solução não estiver nos dados fornecidos, forneça uma solução alternativa ou uma sugestão sobre como solucionar o problema. Caso você precise de mais informações para oferecer uma solução mais precisa, informe quais dados adicionais seriam úteis.`
                        }]
                    }
                ]
            })
